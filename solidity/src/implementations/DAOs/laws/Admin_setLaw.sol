...
//         address Senior_acceptProposedLaw // can take a address parentLaw param.
//     )
//         Law(
...
//         (address law, bool toInclude) = abi.decode(lawCalldata, (address, bool));
...
//         if (SeparatedPowers(payable(agDao)).state(parentProposalId) != SeparatedPowersTypes.ProposalState.Completed) {
