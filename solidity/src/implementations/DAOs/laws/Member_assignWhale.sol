...
//         tar[1] = agCoins;
//         val[1] = 0;
//         cal[1] = abi.encodeWithSelector(IERC20.transfer.selector, executioner, agCoinsReward);
...
//             cal[0] = abi.encodeWithSelector(0xd2ab9970, WHALE_ROLE, accountToAssess, false); // = setRole(uint48 roleId, address account, bool access);
//         }
...
//             cal[0] = abi.encodeWithSelector(0xd2ab9970, WHALE_ROLE, accountToAssess, true); // = setRole(uint48 roleId, address account, bool access);
//         } else {
