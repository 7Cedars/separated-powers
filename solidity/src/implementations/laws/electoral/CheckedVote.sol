...
//     constructor(
//         address payable agDao_ // can take a address parentLaw param.
//     )
//         Law(
...
//             type(uint48).max, // = access PUBLIC_ROLE
...
//         tar[0] = agDao;
//         val[0] = 0;
//         cal[0] = abi.encodeWithSelector(0xd2ab9970, 3, executioner, true); // = setRole(uint48 roleId, address account, bool access);
