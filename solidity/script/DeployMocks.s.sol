...
contract DeployMocks is Script {
    ...
    function run()
        external
        returns (address payable erc20VotesMock, address payable erc721Mock, address payable erc1155Mock)
    {
        ...
        return (payable(address(erc20Votes)), payable(address(erc721)), payable(address(erc1155)));
    }
}
