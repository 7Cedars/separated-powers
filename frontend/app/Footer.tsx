...
export function Footer() {
  ...
  return (
    <section className="w-full min-h-fit bg-slate-50 flex md:flex-row flex-col justify-between md:items-start items-center text-slate-800 text-sm px-16 snap-end pt-12 pb-6 border-t border-slate-300 gap-16 snap-end">
