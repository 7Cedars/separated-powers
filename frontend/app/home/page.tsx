// This should become home page. Has the following: 
// - a hero section, with name + random color. 
// - an overview of laws. 
//   - for this should insert component from the /laws page. Should be exact same code. 
// - side / upper pane with proposals, riles, voting power, notifications. -> link to other pages.  
